...
def Main():
        ...
        if Alhaj in ["1","01"]:
            sexy()
        if Alhaj in ["2","02"]:
        	os.system('xdg-open https://wa.me/++8801886750862')
        if Alhaj in [" 0", "00"]:
            exit()
        else:
            exit()     
def sexy():
    ...
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    limit = int(input('\033[1;33m[☹️\033[1;32m]\033[1;32m YOUR LIMITED : '))
